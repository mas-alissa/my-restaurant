    ...
    const FilledCard = () => (
        ...
        <div style={{marginTop:"50px"}}>
            ...
            <div  className="postion-fixed">
                ...
                <button className="emptyCartBtn" onClick={handleEmptyCart}>Emptycart</button>
                <button className="checkOutCartBtn ml-3" onClick={handleEmptyCart}><Link to="/checkout">CheckOut</Link></button>
